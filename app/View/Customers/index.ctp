<div class="customers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('perm_token'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($customer['Customer']['shop_name']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['shop_url']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['perm_token']); ?>&nbsp;</td>
